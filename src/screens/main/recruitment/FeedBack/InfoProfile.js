...
export default class InfoProfile extends Component {
    render() {
        ...
        let gender = item ? item.user.gender : null;
        let _gender = null;
        switch (gender) {
            case 0:
                _gender = "Nam";
        ...
        let address = item ? item.user.address : null;
        ...
        return (
            <View style={styles.constainer}>
                ...
                <View style={styles.infoStyle}>
                    <Text style={styles.textStyle}>{R.strings.personPage.text_email} {item ? item.user.email : null}</Text>
                    <Text style={styles.textStyle}>{R.strings.personPage.text_gender} {_gender}</Text>
                    <Text style={styles.textStyle}>{R.strings.personPage.text_telephone} {item ?  item.user.telephone.replace(item.user.telephone.substring(7, 10), "***") : null}</Text>
